...
import { User, Mail, Shield, Save, Loader2, Award, CheckCircle, AlertTriangle, Activity, Target, BrainCircuit } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                title="Refresh Feed"
              >
                <Activity className={`w-4 h-4 ${fetchingData ? 'animate-spin' : ''}`} />
              </button>
            </div>
            ...
            <div className="space-y-4">
              {fetchingData ? (
                ...
                <div className="text-center py-20 bg-secondary/10 border border-dashed border-border rounded-2xl">
                  ...
                  <p className="text-muted-foreground text-sm font-mono">No triaged alerts yet. Start your investigation to earn AI ratings.</p>
                </div>
              )}
            </div>
          </div>
