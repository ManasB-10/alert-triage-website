...
import { ShieldPlus, UserCheck, Crown, ArrowLeft, Loader2 } from 'lucide-react';
                ...
                {(!isForgotPasswordView || isVerifiedForReset) && (
                  <div className="space-y-1 animate-in fade-in zoom-in duration-300">
                    ...
                    <input 
                      ...
                      className={`w-full bg-background border ${formErrors.password ? 'border-destructive focus:ring-destructive/50' : 'border-border focus:ring-primary/50'} rounded-lg px-4 py-2.5 text-foreground focus:outline-none focus:ring-2 transition-all text-sm`}
                      placeholder="••••••••"
                    />
                ...
                {(isForgotPasswordView && isVerifiedForReset) && (
                  <div className="space-y-1 animate-in fade-in zoom-in duration-300">
                    ...
                    <input 
                      ...
                      className={`w-full bg-background border ${formErrors.confirmPassword ? 'border-destructive focus:ring-destructive/50' : 'border-border focus:ring-primary/50'} rounded-lg px-4 py-2.5 text-foreground focus:outline-none focus:ring-2 transition-all text-sm`}
                      placeholder="••••••••"
                    />
          ...
          <div className="space-y-3">
            <div className="flex flex-col gap-1 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2 font-mono bg-background/50 p-2 rounded border border-border/50 text-muted-foreground">
                ...
                <span className="truncate" title="demojunior">👤 demojunior</span>
            ...
            <div className="flex flex-col gap-1 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2 font-mono bg-background/50 p-2 rounded border border-border/50 text-muted-foreground">
                ...
                <span className="truncate" title="Sentinel#2024">🔑 Sentinel#2024</span>
                <span className="truncate" title="demomanager">👤 demomanager</span>
